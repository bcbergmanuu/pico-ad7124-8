...
const struct ad7124_st_reg ad7124_regs_config_a[AD7124_REG_NO] = {
	...
	{0x09, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(0) | AD7124_CH_MAP_REG_AINP(3) | AD7124_CH_MAP_REG_AINM(2), 2, 1}, /* AD7124_Channel_0 */
	{0x0A, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(1) | AD7124_CH_MAP_REG_AINP(1) | AD7124_CH_MAP_REG_AINM(0), 2, 1}, /* AD7124_Channel_1 */
	{0x0B, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(2) | AD7124_CH_MAP_REG_AINP(5) | AD7124_CH_MAP_REG_AINM(4), 2, 1}, /* AD7124_Channel_2 */
	{0x0C, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(3) | AD7124_CH_MAP_REG_AINP(7) | AD7124_CH_MAP_REG_AINM(6), 2, 1}, /* AD7124_Channel_3 */
	{0x0D, 0x0001,2,1},
	{0x0E, 0x0001,2,1},
	{0x0F, 0x0001,2,1},
