...
=======
	{0x09, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(0) | AD7124_CH_MAP_REG_AINP(8) | AD7124_CH_MAP_REG_AINM(0b10011), 2, 1}, /* AD7124_Channel_0 */
	{0x0A, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(0) | AD7124_CH_MAP_REG_AINP(9) | AD7124_CH_MAP_REG_AINM(0b10011), 2, 1}, /* AD7124_Channel_1 */
	{0x0B, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(0) | AD7124_CH_MAP_REG_AINP(10) | AD7124_CH_MAP_REG_AINM(0b10011), 2, 1}, /* AD7124_Channel_2 */
	{0x0C, AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(0) | AD7124_CH_MAP_REG_AINP(11) | AD7124_CH_MAP_REG_AINM(0b10011), 2, 1}, /* AD7124_Channel_3 */
...
=======
	...
	{0x1D, 0x0001, 2,1 }, /* AD7124_Config_4 */
	{0x1E, 0x0001, 2,1 },/* AD7124_Config_5 */
	{0x1F, 0x0001, 2,1 },/* AD7124_Config_6 */
	{0x20, 0x0001, 2,1 },/* AD7124_Config_7 */
	{0x21, AD7124_FILT_REG_FS(filterFS), 3, 1}, /* AD7124_Filter_0 */
	{0x22, AD7124_FILT_REG_FS(filterFS), 3, 1}, /* AD7124_Filter_1 */
	{0x23, AD7124_FILT_REG_FS(filterFS), 3, 1},/* AD7124_Filter_2 */
	{0x24, AD7124_FILT_REG_FS(filterFS), 3, 1},/* AD7124_Filter_3 */
